  ...
  definition:
    ...
    env:
      ...
      - name: NETWORK_PACKET_CORRUPTION_PERCENTAGE
        value:  "{{if .Args.NETWORK_PACKET_CORRUPTION_PERCENTAGE}}{{.Args.NETWORK_PACKET_CORRUPTION_PERCENTAGE}}{{else}}100{{end}}"
      ...
      - name: SOCKET_PATH
        value: "{{if .Args.SOCKET_PATH}}{{.Args.SOCKET_PATH}}{{else}}/var/run/docker.sock{{end}}"
      - name: SEQUENCE
